...
/* Zucchini partial MAR apply success test where the callback binary is the
 * file being patched by the update. This exercises the code path where the
 * updater must lock the newly-written callback executable before it finishes
 * writing it, to prevent a new Firefox instance from launching from the
 * partially-written binary mid-update.
 *
